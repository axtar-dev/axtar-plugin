 ...
 */
export function driftAdvisory(consultRequired, ruleIds) {
    if (!consultRequired || ruleIds.length === 0)
        return null;
    return (`Axtar Mentor (advisory): this file is under high-altitude Mentor governance ` +
...
//# sourceMappingURL=drift-advisory.js.map