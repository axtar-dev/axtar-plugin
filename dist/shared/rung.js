...
export function rung2EscalationFraming() {
    return [
...
export function rung2Heartbeat() {
    return ('Axtar Rung 2 active (configured project policy): keep driving this to a ' +
        'Mentor-approved fix — the owner reviews the finished work rather than each step.');
}
//# sourceMappingURL=rung.js.map