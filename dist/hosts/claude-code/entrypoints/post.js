...
const POST_SEVERITIES = new Set(['warning', 'suggestion']);
async function main() {
...
main().catch((err) => {
    ...
    traceRaw(`[${new Date().toISOString()}] hook.crash hook="PostToolUse" message=${JSON.stringify(message)} stack=${JSON.stringify(stack)}\n`);
